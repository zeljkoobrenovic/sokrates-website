...
The **configComplete** completes missing fields in the configuration file. You can also use the configComplete command to upgrade your configuration file to the latest version.
...
***Figure 3:** The **configComplete** completes missing fields in the configuration file.*
