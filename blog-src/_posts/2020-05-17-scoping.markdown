...
permalink: scoping
icon: scoping
excerpt: "Scoping defines which code needs to be analyzed in details and which code can be ignored. The code that developers wrote manually is the most important. It contains critical content for understanding the system's unique structure, logic, and team's design decisions."
---
